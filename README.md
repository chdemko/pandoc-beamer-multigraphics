# pandoc-beamer-block
![Python package](https://github.com/chdemko/pandoc-beamer-multigraphics/workflows/Python%20package/badge.svg?branch=develop)
...
[![PyPI version](https://img.shields.io/pypi/v/pandoc-beamer-multigraphics.svg?logo=Python&logoColor=white)](https://pypi.org/project/pandoc-beamer-block/)
...
See the [Read the docs pages](http://pandoc-beamer-multigraphics.readthedocs.io/en/latest/).
